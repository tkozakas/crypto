...
cText = '''
LVOMP KASTA GPBUJ GWQSA OJMFF 
GRANF IBSOP WMNGC NWCNL JXRDU 
QMJMQ EQWXE
'''
key = 3
...
def brute_force_second_key(key_part_1, L1, L2, cText_2):
    ...
    for key_part_2 in range(26):  # for each possible value of the second part of the key
        ...
        if decrypted_text.startswith('T'):  # if the decryption starts with 'U'
            result.append((decrypted_text, key_part_2))
    return result

print(brute_force_second_key(key, L_1, L_2, cText))
